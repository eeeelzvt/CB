...
money = [usd_rub_day, usd_rub_week, usd_rub_month, euro_rub_day, euro_rub_week, euro_rub_month, euro_usd_day,
         euro_usd_week, euro_usd_month]
most_v = []
name_money = ['usd->rub', 'euro->rub', 'euro->usd']
...
print('Самая выгодный перевод на следующую неделю: ', name_money[np.array(most_v[::3]).argmax()])
print('Самая выгодный перевод на следующий месяц: ', name_money[np.array(most_v[1::3]).argmax()])
print('Самая выгодный перевод на следующий квартал: ', name_money[np.array(most_v[2::3]).argmax()])
